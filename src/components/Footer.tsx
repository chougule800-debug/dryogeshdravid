...
import { Stethoscope, MapPin, Phone, Clock, Heart, Calendar, Lock } from 'lucide-react';
...
export const Footer: React.FC<FooterProps> = ({ onContactClinic, onOpenAdmin, clinics }) => {
  ...
  return (
    <footer id="contact" className="bg-[#0c1d1a] text-slate-300 pt-8 pb-4 sm:pt-10 sm:pb-6 border-t border-emerald-950/60">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-6 lg:gap-12 pb-6 sm:pb-8 border-b border-emerald-900/40">
          <div className="lg:col-span-6 space-y-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="text-xl font-bold text-white font-serif-display">Dr. Dravid's</span>
                <span className="block text-[11px] font-semibold text-emerald-400 uppercase tracking-wider">Homeopathic Clinic</span>
              </div>
            </div>
            ...
            <div className="pt-1">
              <button onClick={onContactClinic} className="px-4 py-2 sm:px-5 sm:py-2.5 rounded-full bg-[#335e35] hover:bg-[#284c2a] text-white font-semibold text-xs shadow-md transition-all cursor-pointer inline-flex items-center gap-2">
          ...
          <div className="lg:col-span-6 space-y-2">
            ...
            <div className="space-y-1 text-xs sm:text-sm text-slate-300">
              <p className="font-semibold text-white text-sm sm:text-base">{clinicName}</p>
              <p>{clinicAddress}</p>
        ...
        <div className="pt-4 sm:pt-6 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-slate-400">
          <div className="flex items-center gap-4 flex-wrap justify-center sm:justify-start">
            <span>&copy; {new Date().getFullYear()} Dr. Dravid's Homeopathic Clinic. All rights reserved.</span>
            {onOpenAdmin && (
              <button onClick={onOpenAdmin} className="text-slate-400 hover:text-emerald-300 transition-colors inline-flex items-center gap-1 cursor-pointer" title="Admin Management Portal">
          ...
          <div className="flex items-center gap-2 text-slate-300 font-medium">
            <span>Design by</span>
            <a href="tel:9902686173" className="text-emerald-400 hover:text-emerald-300 font-semibold transition-colors flex items-center gap-1">
