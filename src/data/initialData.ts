...
export const CLINICS: ClinicLocation[] = [
  {
    ...
    scheduleNote:
      'Morning session is exclusively for new cases. Evening session is only for follow-up cases (new cases only in acute emergencies). Saturday & Sunday closed.',
    isSpecialSchedule: false,
    mapQuery: "Dr Dravid's Homoeopathic Clinic, Vadagaon, Yallur road, Belgaum",
    googleMapEmbedUrl:
      'https://www.google.com/maps?q=Yallur+road+vadagaon+opp+Kalpvruksh+hotel+Belgaum&output=embed',
  },
  {
    id: 'goa',
    ...
    address:
      'Dr. Trupti Naik’s Vidhishree Ayurvedic Clinic, Dasha Arcade, Beside HDFC Bank',
    landmark: 'Beside HDFC Bank, Dasha Arcade',
    city: 'Quepem, South Goa',
    state: 'Goa - 403705',
    phone: '8762465349',
    email: 'drdravidclinic@gmail.com',
    timings: ['Every First Sunday of the Month: 10:00 AM to 2:00 PM (Sharp)'],
    scheduleNote:
      'Special monthly clinical visit by Dr. Yogesh Dravid. Prior phone booking is mandatory.',
    isSpecialSchedule: true,
    specialRule: 'Every First Sunday (10:00 AM – 2:00 PM)',
    mapQuery: 'Dasha arcade Beside HDFC Bank Quepem South Goa',
    googleMapEmbedUrl:
      'https://www.google.com/maps?q=Dasha+arcade+Beside+HDFC+Bank+Quepem+South+Goa&output=embed',
  },
];
...
export const INITIAL_PRE_POST_CASES: PrePostCase[] = [
  {
    ...
    beforeMediaUrl:
      'https://images.unsplash.com/photo-1584017911766-d451b3d0e843?auto=format&fit=crop&q=80&w=700',
    afterMediaType: 'image',
    afterMediaUrl:
      'https://images.unsplash.com/photo-1512290900672-1f48615b81a4?auto=format&fit=crop&q=80&w=700',
    remedyPrescribed:
      'Arsenicum Album 200CH followed by Sulphur 1M (Constitutional)',
    description:
      'Patient presented with extensive silvery scaly erythema across bilateral forearms and legs with intense itching and burning aggravated in cold weather. Allopathic steroid topicals had only provided temporary suppression.',
    outcomeNotes:
      'Complete clearance of psoriatic plaques, restoration of normal epidermal texture with no recurrence over 18 months of follow-up.',
  ...
  },
  {
    ...
    afterMediaType: 'image',
    afterMediaUrl:
      'https://images.unsplash.com/photo-1527799820374-dcf8d9d4a388?auto=format&fit=crop&q=80&w=700',
    remedyPrescribed: 'Phosphorus 200CH & Fluoricum Acidum 30C',
    description:
      'Sudden onset of smooth circular bald patches on scalp following severe exam stress and emotional grief. Hair shafts exhibited characteristic exclamation mark hairs.',
    outcomeNotes:
      'Complete follicular regeneration with thick, natural pigmented hair growth filling all bald spots.',
  ...
  },
  {
    ...
    beforeMediaType: 'image',
    beforeMediaUrl:
      'https://images.unsplash.com/photo-1584515979956-d9f6e5d09982?auto=format&fit=crop&q=80&w=700',
    afterMediaType: 'image',
    afterMediaUrl:
      'https://images.unsplash.com/photo-1502086223501-7ea6ecd79368?auto=format&fit=crop&q=80&w=700',
    remedyPrescribed:
      'Tuberculinum Bovinum 200C followed by Natrum Sulphuricum 30C',
    description:
      'Child had weekly attacks of nocturnal dyspnea, dry spasmodic cough, and severe dust allergy requiring regular nebulization and bronchodilators.',
    outcomeNotes:
      'Nebulizers tapered off completely within 6 weeks. Child is now active in outdoor sports with zero respiratory distress.',
  ...
  },
  {
    ...
    beforeMediaType: 'image',
    beforeMediaUrl:
      'https://images.unsplash.com/photo-1579684385127-1ef15d508118?auto=format&fit=crop&q=80&w=700',
    afterMediaType: 'image',
    afterMediaUrl:
      'https://images.unsplash.com/photo-1576091160550-2173dba999ef?auto=format&fit=crop&q=80&w=700',
    remedyPrescribed: 'Thuja Occidentalis 1M & Causticum 200C',
    description:
      'Painful, bleeding verrucous growths on right cheek and palmar surface that had recurred twice after surgical electrocautery.',
    outcomeNotes:
      'Painless withering and natural detachment of all warts within 45 days, leaving flawless scar-free skin.',
...
export const INITIAL_GALLERY: GalleryItem[] = [
  {
    ...
    mediaType: 'image',
    mediaUrl: '/images/dr_yogesh_dravid.jpg',
    caption:
      'Dr. Yogesh Dravid at the consultation desk with portrait of Dr. Samuel Hahnemann at the Belgaum Clinic.',
    date: 'Belgaum Clinic',
  },
  {
    id: 'gal-3',
    ...
    category: 'Pharmacy',
    mediaType: 'image',
    mediaUrl: '/images/homeopathy_hero_banner_1787248330468.jpg',
    caption:
      'Pure lactose globules, mother tinctures, and German dilution potencies prepared under strict hygienic standards.',
    date: 'Dispensary',
  },
  {
    id: 'gal-4',
    ...
    mediaType: 'image',
    mediaUrl:
      'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?auto=format&fit=crop&q=80&w=900',
    caption:
      'Academic seminars, pharmacy laboratory research, and physiological lectures led by faculty professors.',
  ...
  },
  {
    ...
    caption:
      'Comfortable waiting lounge and consultation room for Goa First-Sunday patient appointments.',
  ...
  },
  {
    ...
    mediaType: 'image',
    mediaUrl:
      'https://images.unsplash.com/photo-1512069772995-ec65ed45afd6?auto=format&fit=crop&q=80&w=900',
    caption:
      'Preserving medicinal plants and dynamic phytochemical principles in accordance with Organon of Medicine.',
...
export const INITIAL_BLOG_POSTS: BlogPost[] = [
  {
    id: 'post-1',
    title:
      'Why Human Physiology is the Foundation of True Constitutional Prescribing',
    ...
    readTime: '6 min read',
    excerpt:
      'Understanding physiological homeostasis, autonomic tone, and cellular adaptation enables a homoeopath to identify the true constitutional remedy with pinpoint accuracy.',
    mediaType: 'image',
    mediaUrl:
...
At Dr. Dravid's Clinic, our clinical diagnostic method bridges deep physiological analysis with Hahnemannian repertorization, ensuring every prescription matches the core blueprint of the individual.`,
  },
  {
    id: 'post-2',
    title:
      'Holistic Homeopathic Solutions for Chronic Skin Disorders: Eczema & Psoriasis',
    ...
    readTime: '5 min read',
    excerpt:
      'The skin is a mirror of internal gut health, immune reactivity, and emotional strain. Why topical creams fail, and how homeopathy addresses the root cause.',
    mediaType: 'image',
    mediaUrl:
      'https://images.unsplash.com/photo-1584017911766-d451b3d0e843?auto=format&fit=crop&q=80&w=900',
...
True healing occurs from within outward, from above downward, and in reverse order of the symptoms' appearance (Hering's Law of Cure).`,
  },
  {
    id: 'post-3',
    title:
      'Demystifying Sweet Sugar Globules: How Homoeopathic Potencies Work',
    ...
    readTime: '4 min read',
    excerpt:
      'Those small white sugar pills are merely inert vehicles carrying dynamized, potentized micro-energetic medicine. Here is the science behind nanomedicine and water memory.',
    mediaType: 'image',
    mediaUrl: '/images/homeopathy_hero_banner_1787248330468.jpg',
...
export const INITIAL_TESTIMONIALS: Testimonial[] = [
  {
    ...
    comment:
      "I had suffered from severe acidity and unbearable unilateral headaches for over 6 years. Dr. Yogesh Dravid's constitutional treatment cured my condition in just 3 months without any recurrence.",
    rating: 5,
  ...
  },
  {
    ...
    comment:
      'I travel to the Quepem clinic on the First Sunday every month. Dr. Dravid gave me a clear dietary guidance and potentized constitutional homeopathic drops. My menstrual cycles are now completely regular and skin is crystal clear.',
    rating: 5,
    treatedBy: 'Dr. Yogesh Dravid',
  ...
  },
  {
    ...
    comment:
      'Being right opposite Kalpvruksh Hotel, the clinic is very convenient. Dr. Dravid explained the physiological degeneration and gave gentle remedies. My knee stiffness and swelling reduced tremendously.',
    rating: 5,
    treatedBy: 'Dr. Yogesh Dravid',
  ...
  },
  {
    ...
    comment:
      'After years of applying steroid ointments with frequent relapses, Dr. Yogesh Dravid took my complete constitutional history in the morning session. In 4 months, my skin lesions cleared completely without any side effects!',
    rating: 5,
    treatedBy: 'Dr. Yogesh Dravid',
    treatmentDuration: '4 Months',
  },
  {
    ...
    comment:
      'My 7-year-old son used to need frequent nebulization every monsoon. Since starting Dr. Dravid’s monthly consultation in Goa, his natural immunity has strengthened and he has not needed an inhaler for over a year.',
    rating: 5,
    treatedBy: 'Dr. Yogesh Dravid',
  ...
  },
  {
    ...
    comment:
      'Dr. Dravid’s deep understanding of physiology made a huge difference. He adjusted my constitutional doses and monitored my thyroid profile. My energy levels have returned and thyroid parameters are now stable.',
    rating: 5,
    treatedBy: 'Dr. Yogesh Dravid',
...
export const CLINICAL_SERVICES: ClinicalServiceItem[] = [
  {
    ...
    description:
      'In-depth holistic case-taking assessing physical, emotional, and hereditary factors to stimulate the body’s innate vital healing power.',
  ...
  },
  {
    ...
    description:
      'Long-term healing for arthritis, thyroid dysfunction, chronic fatigue, fibromyalgia, migraine, and recurring metabolic disorders.',
  ...
  },
  {
    ...
    description:
      'Effective, scar-free treatment for psoriasis, eczema, acne, vitiligo, fungal infections, warts, and alopecia areata hair loss.',
  ...
  },
  {
    ...
    description:
      'Relief and immunity modulation for chronic sinusitis, allergic rhinitis, asthma, bronchitis, and seasonal weather sensitivity.',
  ...
  },
  {
    ...
    description:
      'Gentle, sweet-tasting remedies for recurrent tonsillitis, low immunity, poor appetite, teething troubles, and behavioral challenges.',
  ...
  },
  {
    ...
    description:
      'Natural therapeutic balance for PCOS/PCOD, irregular menses, fibroids, menopause, thyroid issues, and postpartum wellbeing.',
