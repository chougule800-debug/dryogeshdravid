...
export const CLINICS: ClinicLocation[] = [
  ...
  },
  {
    ...
    email: 'drdravidclinic@gmail.com',
    timings: [
      'Every First Sunday of the Month: 10:00 AM to 2:00 PM (Sharp)',
    ],
...
export const INITIAL_GALLERY: GalleryItem[] = [
  ...
  },
  {
    ...
    caption: 'Comfortable waiting lounge and consultation room for Goa First-Sunday patient appointments.',
...
export const INITIAL_TESTIMONIALS: Testimonial[] = [
  ...
  },
  {
    ...
    comment: "I travel to the Quepem clinic on the First Sunday every month. Dr. Dravid gave me a clear dietary guidance and potentized constitutional homeopathic drops. My menstrual cycles are now completely regular and skin is crystal clear.",
    rating: 5,
    treatedBy: 'Dr. Yogesh Dravid',
